          ...
          {React.createElement(
            headerBox,
            {
              children: React.array([
                ...
                <div key="row1" className="flex items-center justify-between w-full">
                ...
                <div key="row2" className="flex items-center justify-between w-full gap-2">
                ...
                React.createElement(
                  linkAnchor,
                  {
                    ...
                    children: React.array([
                      <svg
                        key="svg"
                        className="w-4 h-4 rounded-xs shadow-2xs"
                        viewBox="0 0 250 250"
                        fill="none"
                      >
                        <path
                      ...
                      <span key="txt"> {Utils.renderString("ReScript v12")} </span>,
                    ]),
                  },
                ),
                <span key="pipe" className="text-[#d8cbb3] font-normal">
                  {Utils.renderString("|")}
                </span>,
                React.createElement(
                  linkAnchor,
                  {
                    ...
                    rel: "noopener noreferrer",
                    children: React.array([
                      <svg key="svg" className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                      ...
                      <span key="txt"> {Utils.renderString("GitHub")} </span>,
                    ]),
                  },
                ),
              ]),
