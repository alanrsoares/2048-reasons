    ...
    <div className="w-full max-w-[460px] flex flex-col items-center gap-5 my-auto">
      ...
      <header className="w-full flex flex-col gap-4">
        ...
        <div className="flex items-start justify-between w-full">
          /* 2048 Title Container with Official ReScript Brandmark Badge (Original Color) */
          <div className="relative inline-block">
            ...
            <span
              className="absolute bottom-0 right-0 translate-y-3/4 flex items-center gap-1.5 px-2 py-0.5 rounded bg-[#edc22e] text-white font-black text-[9px] sm:text-[10px] tracking-wider uppercase whitespace-nowrap shadow-xs"
            >
              <svg className="w-3.5 h-3.5 rounded-2xs" viewBox="0 0 250 250" fill="none">
                <path
                  fill="#E84F4F"
